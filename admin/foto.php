    ...
    <div class="row">
        <div class="col-md-4">
            <div class="card mt-2 bg-purple">
                <div class="card-header bg-pink">Tambah Foto</div>
                <div class="card-body">
                            ...
                            <tr>
                                ...
                                <div class="modal fade" id="edit<?php echo $data['fotoid'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        ...
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#hapus<?php echo $data['fotoid'] ?>">Hapus
                                </button>

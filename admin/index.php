...
<nav class="navbar navbar-expand-lg bg-body-tertiary">
  ...
  <img src="../assets/img/bf.jpeg" alt="logo" width="30" height="30" class="d-inline-block align-top rounded-circle mt-1 ">
    ...
    <button class="btn btn-outline-success" type="submit">
        <i class="fa-solid fa-search"></i> <!-- Use the appropriate search icon class -->
    </button>
</form>
...
<div class="container mt-2">
    ...
    while($data = mysqli_fetch_array($query)) {
     ...
     <?php 
      ...
      <a href="../assets/img/<?php echo $data['lokasifile'] ?>" download>
      <i class="fa-solid fa-download"></i></a> download
    </div>
  </div>
  </div>
  <?php } ?>
